...
'WorkbookSheetReclas = "determinación"
...
For i = 0 To objDictionary.Count -1 
    ...
    If iFind Is Nothing Then
        ' Insertar una nueva fila en la posición lastRow
    ...
    If kFind Is Nothing Then
        ' Insertar una nueva columna en la posición 3 (por ejemplo, antes de la columna C)
