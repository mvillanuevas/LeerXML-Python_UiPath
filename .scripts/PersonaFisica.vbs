...
lastCol = WorkbookSheetNomina.Cells(3, WorkbookSheetNomina.Columns.Count).End(-4159).Column + 2 ' -4159 = xlToLeft

'Inserta valortes de XML
If Not mFind Is Nothing Then
	firstAddress = mFind.Address
	Do
		If objWorksheet.Cells(mFind.Row, 3).value = "" Or objWorksheet.Cells(mFind.Row, lastCol).value <> "1" Then
